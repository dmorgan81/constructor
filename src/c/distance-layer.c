...
DistanceLayer *distance_layer_create(void) {
    ...
    fctx_rect_layer_set_handles(data->rect_layer, (FctxRectLayerHandles) {
        .border_color = enamel_get_DISTANCE_RECT_BORDER_COLOR,
        .border_width = enamel_get_DISTANCE_RECT_BORDER_WIDTH,
        .fill_color = enamel_get_DISTANCE_RECT_FILL_COLOR,
        .alignment = enamel_get_DISTANCE_ALIGNMENT,
        .rotation = enamel_get_DISTANCE_ROTATION,
        .size_w = enamel_get_DISTANCE_RECT_SIZE_W,
        .size_h = enamel_get_DISTANCE_RECT_SIZE_H,
        .offset_x = enamel_get_DISTANCE_X,
        .offset_y = enamel_get_DISTANCE_Y
    });
    ...
    fctx_text_layer_set_handles(data->text_layer, (FctxTextLayerHandles) {
        .fill_color = enamel_get_DISTANCE_COLOR,
        .alignment = enamel_get_DISTANCE_ALIGNMENT,
        .rotation = enamel_get_DISTANCE_ROTATION,
        .font_size = enamel_get_DISTANCE_FONT_SIZE,
        .offset_x = enamel_get_DISTANCE_X,
        .offset_y = enamel_get_DISTANCE_Y
    });
